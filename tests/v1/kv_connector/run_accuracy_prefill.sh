...
VLLM_USE_V1=1 \
VLLM_NIXL_SIDE_CHANNEL_HOST=${ZMQ_HOST} \ 
VLLM_NIXL_SIDE_CHANNEL_PORT=${ZMQ_PORT} \ 
VLLM_NIXL_CPU=1 \
...
# # python toy_proxy_server.py --prefiller-host 10.138.0.14 --prefiller-port 8100 --decoder-host 10.128.0.28 --decoder-port 8200 --port 8192 &

# wait_for_server 8192
